...
const Modules = ({ display, codeTheme }: ModulesProps) => {
    ...
    else if (display === 'Trees')
        return (<Trees codeTheme={codeTheme}></Trees>)
    else if (display === 'Union')
        return (<Union codeTheme={codeTheme}></Union>)
    else if (display === 'TwoPointers')
        return (<TwoPointers codeTheme={codeTheme}></TwoPointers>)
    else if (display === 'Stacks')
        return (<Stacks codeTheme={codeTheme}></Stacks>)
    ...
    else if (display === 'Prefix')
        return (<Prefix codeTheme={codeTheme}></Prefix>)
    else if (display === 'LinkedLists')
        return (<LinkedLists codeTheme={codeTheme}></LinkedLists>)
    else if (display === 'Graphs')
        return (<Graphs codeTheme={codeTheme}></Graphs>)
    else if (display === 'DFS')
        return (<DFS codeTheme={codeTheme}></DFS>)
    else if (display === 'BinarySearch')
        return (<BinarySearch codeTheme={codeTheme}></BinarySearch>)
    else if (display === 'BFS')
        return (<BFS codeTheme={codeTheme}></BFS>)
    else if (display === 'BackTracking')
        return (<BFS codeTheme={codeTheme}></BFS>)
